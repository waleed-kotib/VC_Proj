...
#  
# $Id: tinyhttpd.tcl,v 1.19 2004-11-25 14:08:13 matben Exp $
...
<center>
<br>
<table width="596" border="0" cellspacing="1" cellpadding="4" bgcolor="#A1A5A9">
    <tr>
...
proc ::tinyhttpd::Respond {token} {    
    ...
    set s   $state(s)
    set cmd $state(cmd)
    set relpath [string trimleft $state(path) /]
    ...
    set abspath [file normalize [file join $options(-rootdirectory) $relpath]]
    ...
    Debug 2 "\t mime=$mime, abspath=$abspath"
...
proc ::tinyhttpd::BuildHtmlDirectoryListing {inPath} {    
    ...
    set relpath [string trimleft $inPath /]
    ...
    # and normalize, i.e. remove all ../
    set localAbsPath  \
      [file normalize [file join $options(-rootdirectory) $relpath]]
    ...
    set htmlStuff [format $html(dirhead,$style) $thisDir $num]
	...
	set link "[string trimright $inPath /]/[uriencode::quotepath $name]"
