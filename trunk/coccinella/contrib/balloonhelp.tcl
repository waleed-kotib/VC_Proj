...
#  
# $Id: balloonhelp.tcl,v 1.1.1.1 2002-12-08 10:54:03 matben Exp $
...
proc ::balloonhelp::balloonforwindow {win msg args} {
    ...
    if {0 && [string equal $::tcl_platform(platform) "macintosh"]} {
	bind $win <Leave> [list ::balloonhelp::MacLeave %W %X %Y]
	bind $win <Motion> [list ::balloonhelp::MacLeave %W %X %Y]
    } else {
