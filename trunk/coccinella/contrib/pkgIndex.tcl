...
package ifneeded getfile 1.0 [list source [file join $dir getfile getfile.tcl]]
...
package ifneeded mylabelframe 0.1 [list source [file join $dir mylabelframe.tcl]]
