...
#  
# $Id: tinyhttpd.tcl,v 1.29 2006-04-13 10:45:05 matben Exp $
...
<!-- HTML generated by tinyhttpd -->}
	...
	<head>
	    <title>Coccinella: directory listing</title>
	    <meta http-equiv='Content-Type' content='text/html; charset=utf-8'/>
	    <link href="/httpd/std.css" type='text/css' rel='stylesheet'/>
	</head>
	<body>
	<!-- HTML generated by tinyhttpd -->
	<h2>%s contains %s items</h2>
    ...
    <div id='footerouter'>
    <div id="footer">
        <a href="http://hem.fyristorg.com/matben/">Powered by Coccinella, a free instant messaging client.</a>
    </div>
    </div>
    </body>
    </html>
...
proc ::tinyhttpd::BuildHtmlForDir {token} {    
    ...
    set htmlStuff    [format $html(head,$style) $dirname $num]
    if {$relpath ne ""} {
	append htmlStuff [format $html(updir,$style) $uprpath $imgup $upname]
    }
    append htmlStuff [format $html(tabletop,$style)]
